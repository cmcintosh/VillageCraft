...
public class BlockCaptainsArmorBlock extends Block {
	
	public static Properties properties = Properties.create(Material.WOOD).hardnessAndResistance(3.5F).sound(SoundType.METAL).notSolid();
	...
	public BlockCaptainsArmorBlock(Properties properties) {
		super(properties);
