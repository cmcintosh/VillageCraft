...
public class BlockVillageCenter extends Block {
...
//        tooltip.add(Component.translatable("block.vcm.village_center.desc0").withStyle(TextFormatting.GRAY));
//        tooltip.add(Component.translatable("block.vcm.village_center.desc1").withStyle(TextFormatting.GRAY));
    }
