...
public class BlockMicrophoneStand extends Block {
	
	public static Properties properties = Properties.create(Material.WOOD).hardnessAndResistance(3.5F).sound(SoundType.CHAIN).notSolid();
	...
	public BlockMicrophoneStand(Properties properties) {
		super(properties);
