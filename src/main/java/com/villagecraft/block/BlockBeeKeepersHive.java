...
public class BlockBeeKeepersHive extends Block {

	public static Properties properties = Properties.create(Material.WOOD).hardnessAndResistance(3.5F).sound(SoundType.WET_GRASS).notSolid();
	...
	public BlockBeeKeepersHive(Properties properties) {
		super(properties);
