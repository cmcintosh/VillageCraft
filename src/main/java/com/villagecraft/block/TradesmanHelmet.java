...
public class TradesmanHelmet extends Block {
	...
	public static net.minecraft.item.Item.Properties item_properties = new net.minecraft.item.Item.Properties().group(ModVillagerProfessions.PROFESSION_BLOCKS).maxStackSize(6);

	public TradesmanHelmet(Properties properties) {
		super(properties);
