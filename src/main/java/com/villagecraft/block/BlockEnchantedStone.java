...
public class BlockEnchantedStone extends Block {
	
	public static Properties properties = Properties.create(Material.WOOD).hardnessAndResistance(3.5F).sound(SoundType.WOOD).notSolid();
	...
	public BlockEnchantedStone(Properties properties) {
		super(properties);
