...
public class OreLootTableProvider extends ForgeLootTableProvider {
	...
	private static class Blocks extends BlockLootTables {
	   ...
	   protected static LootTable.Builder dropping(Block block, ILootCondition.IBuilder conditionBuilder, LootEntry.Builder<?> p_218494_2_) {
		...
		protected void addTables() {
			...
			for (RegistryObject<Block> entry : ModOres.BLOCKS.getEntries()) {
	    ...
	    protected Iterable<Block> getKnownBlocks() {
			return ModOres.BLOCKS.getEntries().stream().map(RegistryObject::get)::iterator;
		}
