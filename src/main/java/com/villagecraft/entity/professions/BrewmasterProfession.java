...
public class BrewmasterProfession extends VillagerCraftBaseProfession {
	...
	public VillagerProfession PROFESSION = ModVillagerProfessions.BREWMASTER.get();
	
	/**
	 * {@inheritDoc}
	 */
	public BrewmasterProfession(String nameIn, PointOfInterestType pointOfInterestIn, 
