...
public class BlacksmithProfession extends VillagerCraftBaseProfession {
	
	public static final ImmutableSet<Item> PROFESSION_ITEM = ImmutableSet.of(ModItems.BEER_BUCKET.get());
	public static final ImmutableSet<Block> PROFESSION_BLOCK = ImmutableSet.of(Blocks.ANVIL);
	public VillagerProfession PROFESSION = ModVillagerProfessions.BLACKSMITH.get();
	
	/**
	 * {@inheritDoc}
	 */
	public BlacksmithProfession(String nameIn, PointOfInterestType pointOfInterestIn, 
	...
	public static void RegisterVillagerTrades(VillagerTradesEvent event) { 
		if (event.getType() == ModVillagerProfessions.BLACKSMITH.get()) {
