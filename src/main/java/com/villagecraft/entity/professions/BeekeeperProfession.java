...
public class BeekeeperProfession extends VillagerCraftBaseProfession {
	...
	public VillagerProfession PROFESSION = ModVillagerProfessions.BEEKEEPER.get();
	
	/**
	 * {@inheritDoc}
	 */
	public BeekeeperProfession(String nameIn, PointOfInterestType pointOfInterestIn, 
