...
public class VillageCraftVillager extends VillagerEntity {
	...
	public VillageCraftVillager(EntityType<? extends VillagerEntity> type, World worldIn) {
		super(type, worldIn);
	}
	
	public VillageCraftVillager(EntityType<? extends VillagerEntity> type, World worldIn, VillageCraftVillagerData data) {
		super(type, worldIn);
